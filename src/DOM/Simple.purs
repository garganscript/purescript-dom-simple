...
import DOM.Simple.Types (class IsChild, class IsElement, class IsEventListener, class IsNode, class IsParent, class IsSibling, DOMRect, Document, Element, Fragment, Text, Window) as Exports
...
import DOM.Simple.Window ( window, global ) as Exports
